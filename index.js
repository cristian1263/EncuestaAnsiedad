...
$(document).ready(function () {
  $('#btnEnviar').click(function () {
    var faltantes = respuestasFaltantes();
    calcAnsiedad(faltantes);
  });
});
...
function respuestasFaltantes() {
  ...
  return faltanRespuestas;
}

function calcAnsiedad(faltanRespuestas) {
  ...
  function crearJson() {
    ...
    if (terminosAceptados) {
      var encuestaData = {
        ...
        Total: respuestaCalc[0],
        Resultado: respuestaCalc[1],
